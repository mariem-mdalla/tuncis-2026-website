...
const organizing = [
  ...
  { name: "Full Name", role: "Organizing Committee", affiliation: "TunAISia" },
];

const scientific = [
  { name: "Full Name", role: "Scientific Committee", affiliation: "Université de Sousse" },
  { name: "Full Name", role: "Scientific Committee", affiliation: "Université de Carthage" },
];
        ...
        {members.map((m, i) => (
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-tuncis-gray mb-3 font-medium">{m.role}</p>
