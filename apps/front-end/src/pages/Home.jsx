...
export default function Home() {
  const highlights = [
    { title: "Keynotes", desc: "Talks from leading AI researchers across Tunisia and Europe.", icon: Presentation },
    { title: "Collaborative Workshops", desc: "Hands-on sessions bridging research and industry practice.", icon: Users },
    { title: "Doctoral Consortium", desc: "A dedicated track for PhD students to present and get feedback.", icon: GraduationCap },
    { title: "NVIDIA Certification", desc: "Optional certified training track for attendees.", icon: Award },
  ];
      ...
      <section className="relative bg-tuncis-blue text-white overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-20 sm:py-28 md:py-32 z-10">
          ...
          >
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-tuncis-yellow to-yellow-200"> co-construct innovation in AI</span>
          </motion.h1>
          ...
          >
            TUNCIS 2026 brings together researchers, practitioners, and PhD students
            from Tunisia and Europe for two days of keynotes, workshops, and a
            Doctoral Consortium.
          </motion.p>
      ...
      <section className="bg-tuncis-bg py-24">
        <div className="max-w-6xl mx-auto px-6">
          <p className="uppercase tracking-wider text-xs text-tuncis-blue font-bold mb-3 flex items-center gap-2">
            <span className="w-8 h-0.5 bg-tuncis-yellow inline-block"></span> Highlights
          </p>
          <h2 className="font-heading text-3xl md:text-4xl text-tuncis-blue mb-12 font-bold">
            What to expect at TUNCIS 2026
          </h2>
            ...
            {highlights.map((item, i) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-heading font-bold text-tuncis-blue text-xl mb-3 relative z-10">{item.title}</h3>
                  <p className="text-sm text-tuncis-gray leading-relaxed relative z-10">{item.desc}</p>
                </motion.div>
              );
            })}
          </div>
